...
namespace ControlTimeService
{
    public partial class ConfigWindow : Window
    {
        ...
        private DaySchedule[] _originalSchedules;

        public ConfigWindow(TimeConfigManager configManager, AppPolicyManager appPolicyManager)
        {
            InitializeComponent();
            ...
            // 保存原始配置用于取消操作
            _originalSchedules = new DaySchedule[7];
            foreach (DayOfWeek day in Enum.GetValues(typeof(DayOfWeek)))
            {
                var schedule = _configManager.GetSchedule(day);
                _originalSchedules[(int)day] = schedule.Clone();
            }
        ...
        private ScrollViewer CreateDayConfigPanel(DayOfWeek day)
        {
            ...
            // 午间规则
            var lunchGroup = new System.Windows.Controls.GroupBox { Header = "午间规则", Margin = new Thickness(0, 15, 0, 10) };
            var lunchPanel = new StackPanel { Margin = new Thickness(10) };
            
            var lunchEnabledCheckBox = new System.Windows.Controls.CheckBox 
            { 
                Content = "启用午间限制", 
            ...
            // 晚间规则
            var eveningGroup = new System.Windows.Controls.GroupBox { Header = "晚间规则", Margin = new Thickness(0, 10, 0, 10) };
            var eveningPanel = new StackPanel { Margin = new Thickness(10) };
            
            var eveningEnabledCheckBox = new System.Windows.Controls.CheckBox 
            { 
                Content = "启用晚间限制", 
            ...
            // 早晨锁定
            var morningGroup = new System.Windows.Controls.GroupBox { Header = "早晨锁定", Margin = new Thickness(0, 10, 0, 10) };
            var morningPanel = new StackPanel { Margin = new Thickness(10) };

            var morningEnabledCheckBox = new System.Windows.Controls.CheckBox
            {
            ...
            // 应用权限（每天独立配置）
            var appPolicyGroup = new System.Windows.Controls.GroupBox { Header = "应用权限", Margin = new Thickness(0, 10, 0, 10) };
        ...
        private System.Windows.Controls.CheckBox CreatePolicyCheckBox(string content, bool isChecked, string tag)
        {
        ...
        private StackPanel CreateTimeRangeInput(string label, string startTime, string endTime, string tag)
        {
            ...
            var timePanel = new StackPanel { Orientation = System.Windows.Controls.Orientation.Horizontal };
            
            var startBox = new System.Windows.Controls.TextBox { Text = startTime, Width = 60, Tag = tag + "_Start" };
            timePanel.Children.Add(startBox);
            timePanel.Children.Add(new System.Windows.Controls.TextBlock { Text = " 至 ", VerticalAlignment = System.Windows.VerticalAlignment.Center, Margin = new Thickness(5, 0, 5, 0) });
            var endBox = new System.Windows.Controls.TextBox { Text = endTime, Width = 60, Tag = tag + "_End" };
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                foreach (TabItem tabItem in DayTabs.Items)
                {
                    ...
                    _configManager.UpdateSchedule(day, schedule);
                }
        ...
        private void CancelButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (DayOfWeek day in Enum.GetValues(typeof(DayOfWeek)))
            {
                _configManager.UpdateSchedule(day, _originalSchedules[(int)day]);
            }
        ...
        private System.Collections.Generic.IEnumerable<System.Windows.Controls.Control> GetAllControls(System.Windows.DependencyObject parent)
        {
